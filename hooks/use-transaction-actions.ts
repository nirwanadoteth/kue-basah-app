...
export function useTransactionActions({
  ...
  const handleAddItem = useCallback(async (productId: number, quantity: number) => {
  ...
  const handleRemoveItem = useCallback(async (detailId: number, productName: string) => {
  ...
  const handleCompleteTransaction = useCallback(async (transaction: TransactionWithDetails) => {
