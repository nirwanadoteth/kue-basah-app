...
class ReadmeValidator {
  ...
  validateStructure() {
    ...
    const requiredSections = ['Overview', 'Deployment', 'Build your app', 'How It Works'];
  ...
  validateContent() {
    ...
    const projectMentions = this.content.match(/supabase.community.starter/gi) || [];
  ...
  validateFormatting() {
    ...
    const badges = this.content.match(/!\[[^\]]*\]\([^)]*shields\.io[^)]*\)/g) || [];
